...
const Search = () => {
    ...
    // send query only once within 500ms, not each keystroke
    ...
    return (
        <View className="flex flex-row items-center justify-between w-full px-4 rounded-lg bg-accent-100 border border-primary-100 mt-5 py-2">
            <View className="flex flex-1 flex-row items-center justify-start z-50">
                ...
                <TextInput className="text-sm font-rubik text-black-300 ml-2 flex-1"
                value={search} onChangeText={handleSearch} placeholder="Search..." />
            </View>
