...
export const FeaturedCard = ({ onPress }: Props) => {
    return (
        <TouchableOpacity className="flex flex-col items-start w-60 h-80 relative">
            ...
            <View className="flex flex-row items-center px-3 py-1.5 bg-white/90 rounded-full absolute top-5 right-5">
            ...
            <View className="flex flex-col items-start absolute bottom-5 inset-x-5">
                ...
                <Text className="text-base font-rubik text-white">Jalan Raja Uda</Text>

                <View className="flex flex-row items-center justify-between w-full">
                    <Text className="text-xl font-rubik-extrabold text-white">RM2,500</Text>
    ...
    return (
        <TouchableOpacity onPress={onPress} className="flex-1 w-full mt-4 px-3 py-4 bg-white shadow-lg shadow-black-100/70 rounded-lg relative">
            ...
            <View className="flex flex-col mt-2">
                ...
                <Text className="text-xs font-rubik text-black-200">Jalan Raja Uda</Text>

                <View className="flex flex-row items-center justify-between mt-2">
                    <Text className="text-base font-rubik-bold text-primary-300">RM2,500</Text>
